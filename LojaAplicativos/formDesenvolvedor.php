<html>
    ...
    <body>
        <div class= "formas" >
          <form name="f1" action="consultas/cadastrarDesenvolvedor.php" method="post"> <h1 align-items: center>Preencha os dados do desenvolvedor:</h1> 
          <table> <tr> <td>

          Id do desenvolvedor:
              <input type="name" id="id" name="id" maxlength="60" size='65'> <P></P>
          ...
          Balanco:
              ...
              <input type="submit" name="cadastrarDesenvolvedor" id="cadastrarDesenvolvedor" value="clique aqui"> 
          </td>
